...
| [`external-links`](e2e/external-links.spec.js) | LinkedIn and GitHub links are exact, every new-tab link is https with `rel="noopener"`, internal links stay relative, and **no page exposes an email address or phone number** |
